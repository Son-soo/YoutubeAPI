 ...
 * youtube_cmdline_search_sample;
 * 
 * import com.google.api.client.googleapis.json.GoogleJsonResponseException;
 * import com.google.api.client.http.HttpRequest; import
 * com.google.api.client.http.HttpRequestInitializer; import
 * com.google.api.client.http.HttpTransport; import
 ...
 * com.google.api.services.youtube.model.ResourceId; import
 * com.google.api.services.youtube.model.SearchListResponse; import
 * com.google.api.services.youtube.model.SearchResult; import
 * com.google.api.services.youtube.model.Thumbnail;
 * 
 * import java.io.BufferedReader; import java.io.IOException; import
 * java.io.InputStream; import java.io.InputStreamReader; import
 * java.util.Iterator; import java.util.List; import java.util.Properties;
 * 
 *//**
 ...
 *//**
	 ...
	 *//*
		 * public static void main(String[] args) { // Read the developer key from
		 * youtube.properties Properties properties = new Properties(); try {
		 ...
		 * 
		 * youtube = new YouTube.Builder(HTTP_TRANSPORT, JSON_FACTORY, new
		 * HttpRequestInitializer() { public void initialize(HttpRequest request) throws
		 * IOException {}
		 * }).setApplicationName("youtube-cmdline-search-sample").build();
		 * 
		 * // Get query term from user. String queryTerm = getInputQuery();
		 * 
		 ...
		 * search.setMaxResults(NUMBER_OF_VIDEOS_RETURNED); SearchListResponse
		 * searchResponse = search.execute();
		 * 
		 * List<SearchResult> searchResultList = searchResponse.getItems();
		 * 
		 * if (searchResultList != null) { prettyPrint(searchResultList.iterator(),
		 * queryTerm); } } catch (GoogleJsonResponseException e) {
		 * System.err.println("There was a service error: " + e.getDetails().getCode() +
		 * " : " + e.getDetails().getMessage()); } catch (IOException e) {
		 ...
		 * bReader.readLine();
		 * 
		 * if (inputQuery.length() < 1) { // If nothing is entered, defaults to
		 * "YouTube Developers Live." inputQuery = "YouTube Developers Live"; } return
		 * inputQuery; }
		 * 
		 * 
		 ...
		 * singleVideo.getId();
		 * 
		 * // Double checks the kind is video. if
		 * (rId.getKind().equals("youtube#video")) { Thumbnail thumbnail =
